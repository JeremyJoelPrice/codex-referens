...
He lived in a volcanic mountain alongside other gnomes and dwarves. Within this mountain was a great source of heat (hence volcanic, but could also be magical or down to a dragon, possibilities are open, can leave thst to your discretion).

The gnomes and drawves within the mountain worked together to forge and produce metal goods (armours, weapons, robots, steam machines etc) using the heat from the mountain. They all lived harmoniously, until one day the big bad enemy (either an army or a group led by a leader) began fracking the mountain for its minerals and rare metals that the dwarves and gnomes used to build.
